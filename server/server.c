...
void take_data_pointers_backup(SSL_CTX *ctx)
{
	...
	fprintf(fp,"%ld\n",ctx->cert_store->objs->data.ptr->pkey->engine->id);
	fprintf(fp,"%ld\n",ctx->name);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->dh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->ecdh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->ecdsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->store_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->cmd_defns);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->prev);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->name->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->rsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->dsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->dh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->ecdh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->ecdsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->store_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->cmd_defns);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->prev);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->engine->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->n);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->e);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p->q);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p->q->dmp1);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p->q->dmp1->dmq1);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p->q->dmp1->dmq1->iqmp);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->d->p->q->dmp1->dmq1->iqmp->_method_mo->_method_mo->_method_mo->bignum_->blinding);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.rsa->mt_blinding);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->p);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->q);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->g);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->pub_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->priv_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->kinv);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->r);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->rsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->dsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->dh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->ecdh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->ecdsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->store_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->cmd_defns);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->prev);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dsa->engine->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->p);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->g);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->pub_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->priv_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->q);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->j);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->counter);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->rsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->dsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->dh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->ecdh_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->ecdsa_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->store_meth);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->cmd_defns);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->prev);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.dh->engine->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->group);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->group->generator);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->group->extra_data);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->group->extra_data->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->pub_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->priv_key);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->method_data);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->pkey.ec->method_data->next);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.asn1_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.object);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.object->sn);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.object->ln);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.integer);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.enumerated);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.bit_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.octet_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.printablestring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.t61string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.ia5string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.generalstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.bmpstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.universalstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.utctime);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.generalizedtime);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.visiblestring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.utf8string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.set);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.set->value.sequence);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.asn1_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.object);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.object->sn);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.object->ln);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.integer);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.enumerated);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.bit_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.octet_string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.printablestring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.t61string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.ia5string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.generalstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.bmpstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.universalstring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.utctime);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.generalizedtime);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.visiblestring);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.utf8string);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.set);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->name->app_data->dsa_meth->attributes->value.single->value.sequence);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->get_cert_methods);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->get_cert_methods->method);
	fprintf(fp,"%ld\n",ctx->name->rsa_meth->get_cert_methods->store_ctx);
	fprintf(fp,"%ld\n",ctx->app_verify_arg);
